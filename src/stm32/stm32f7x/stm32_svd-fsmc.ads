...
package STM32_SVD.FSMC is
   ...
   subtype SDCR_NC_Field is UInt2;
   subtype SDCR_NR_Field is UInt2;
   subtype SDCR_MWID_Field is UInt2;
   subtype SDCR_CAS_Field is UInt2;
   subtype SDCR_SDCLK_Field is UInt2;
   subtype SDCR_RPIPE_Field is UInt2;
   ...
   subtype SDTR_TMRD_Field is UInt4;
   subtype SDTR_TXSR_Field is UInt4;
   subtype SDTR_TRAS_Field is UInt4;
   subtype SDTR_TRC_Field is UInt4;
   subtype SDTR_TWR_Field is UInt4;
   subtype SDTR_TRP_Field is UInt4;
   subtype SDTR_TRCD_Field is UInt4;
   ...
   subtype SDCMR_MODE_Field is UInt3;
   subtype SDCMR_NRFS_Field is UInt4;
   subtype SDCMR_MRD_Field is UInt13;
   ...
   subtype SDRTR_COUNT_Field is UInt13;
   ...
   subtype SDSR_MODES_Element is UInt2;
