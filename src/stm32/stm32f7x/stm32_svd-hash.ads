...
package STM32_SVD.HASH is
   ...
   subtype CR_DATATYPE_Field is UInt2;
   subtype CR_NBW_Field is UInt4;
   ...
   subtype STR_NBLW_Field is UInt5;
   ...
   type HASH_Peripheral is record
      ...
      CSR9     : aliased UInt32;
      --  context swap registers
      CSR10    : aliased UInt32;
      --  context swap registers
      CSR11    : aliased UInt32;
      --  context swap registers
      CSR12    : aliased UInt32;
      --  context swap registers
      CSR13    : aliased UInt32;
      --  context swap registers
      CSR14    : aliased UInt32;
      --  context swap registers
      CSR15    : aliased UInt32;
      --  context swap registers
      CSR16    : aliased UInt32;
      --  context swap registers
      CSR17    : aliased UInt32;
      --  context swap registers
      CSR18    : aliased UInt32;
      --  context swap registers
      CSR19    : aliased UInt32;
      --  context swap registers
      CSR20    : aliased UInt32;
      --  context swap registers
      CSR21    : aliased UInt32;
      --  context swap registers
      CSR22    : aliased UInt32;
      --  context swap registers
      CSR23    : aliased UInt32;
      --  context swap registers
      CSR24    : aliased UInt32;
      --  context swap registers
      CSR25    : aliased UInt32;
      --  context swap registers
      CSR26    : aliased UInt32;
      --  context swap registers
      CSR27    : aliased UInt32;
      --  context swap registers
      CSR28    : aliased UInt32;
      --  context swap registers
      CSR29    : aliased UInt32;
      --  context swap registers
      CSR30    : aliased UInt32;
      --  context swap registers
      CSR31    : aliased UInt32;
      --  context swap registers
      CSR32    : aliased UInt32;
      --  context swap registers
      CSR33    : aliased UInt32;
      --  context swap registers
      CSR34    : aliased UInt32;
      --  context swap registers
      CSR35    : aliased UInt32;
      --  context swap registers
      CSR36    : aliased UInt32;
      --  context swap registers
      CSR37    : aliased UInt32;
      --  context swap registers
      CSR38    : aliased UInt32;
      --  context swap registers
      CSR39    : aliased UInt32;
      --  context swap registers
      CSR40    : aliased UInt32;
      --  context swap registers
      CSR41    : aliased UInt32;
      --  context swap registers
      CSR42    : aliased UInt32;
      --  context swap registers
      CSR43    : aliased UInt32;
      --  context swap registers
      CSR44    : aliased UInt32;
      --  context swap registers
      CSR45    : aliased UInt32;
      --  context swap registers
      CSR46    : aliased UInt32;
      --  context swap registers
      CSR47    : aliased UInt32;
      --  context swap registers
      CSR48    : aliased UInt32;
      --  context swap registers
      CSR49    : aliased UInt32;
      --  context swap registers
      CSR50    : aliased UInt32;
      --  context swap registers
      CSR51    : aliased UInt32;
      --  context swap registers
      CSR52    : aliased UInt32;
      --  context swap registers
      CSR53    : aliased UInt32;
      --  HASH digest register
      HASH_HR0 : aliased UInt32;
      --  read-only
      HASH_HR1 : aliased UInt32;
      --  read-only
      HASH_HR2 : aliased UInt32;
      --  read-only
      HASH_HR3 : aliased UInt32;
      --  read-only
      HASH_HR4 : aliased UInt32;
      --  read-only
      HASH_HR5 : aliased UInt32;
      --  read-only
      HASH_HR6 : aliased UInt32;
      --  read-only
      HASH_HR7 : aliased UInt32;
   end record
     with Volatile;
