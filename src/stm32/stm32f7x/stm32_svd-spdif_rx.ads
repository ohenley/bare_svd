...
package STM32_SVD.SPDIF_RX is
   ...
   subtype CR_SPDIFEN_Field is UInt2;
   subtype CR_DRFMT_Field is UInt2;
   subtype CR_NBTR_Field is UInt2;
   subtype CR_INSEL_Field is UInt3;
   ...
   subtype SR_WIDTH5_Field is UInt15;
   ...
   subtype DR_DR_Field is UInt24;
   subtype DR_PT_Field is UInt2;
   ...
   subtype CSR_USR_Field is UInt16;
   subtype CSR_CS_Field is UInt8;
   ...
   subtype DIR_THI_Field is UInt13;
   subtype DIR_TLO_Field is UInt13;
