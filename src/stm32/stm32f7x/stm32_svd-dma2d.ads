...
package STM32_SVD.DMA2D is
   ...
   subtype CR_MODE_Field is UInt2;
   ...
   subtype FGOR_LO_Field is UInt14;
   ...
   subtype BGOR_LO_Field is UInt14;
   ...
   subtype FGPFCCR_CM_Field is UInt4;
   subtype FGPFCCR_CS_Field is UInt8;
   subtype FGPFCCR_AM_Field is UInt2;
   subtype FGPFCCR_ALPHA_Field is UInt8;
   ...
   subtype FGCOLR_BLUE_Field is UInt8;
   subtype FGCOLR_GREEN_Field is UInt8;
   subtype FGCOLR_RED_Field is UInt8;
   ...
   subtype BGPFCCR_CM_Field is UInt4;
   subtype BGPFCCR_CS_Field is UInt8;
   subtype BGPFCCR_AM_Field is UInt2;
   subtype BGPFCCR_ALPHA_Field is UInt8;
   ...
   subtype BGCOLR_BLUE_Field is UInt8;
   subtype BGCOLR_GREEN_Field is UInt8;
   subtype BGCOLR_RED_Field is UInt8;
   ...
   subtype OPFCCR_CM_Field is UInt3;
   ...
   subtype OCOLR_BLUE_Field is UInt8;
   subtype OCOLR_GREEN_Field is UInt8;
   subtype OCOLR_RED_Field is UInt8;
   subtype OCOLR_APLHA_Field is UInt8;
   ...
   subtype OOR_LO_Field is UInt14;
   ...
   subtype NLR_NL_Field is UInt16;
   subtype NLR_PL_Field is UInt14;
   ...
   subtype LWR_LW_Field is UInt16;
   ...
   subtype AMTCR_DT_Field is UInt8;
   ...
   subtype FGCLUT_BLUE_Field is UInt8;
   subtype FGCLUT_GREEN_Field is UInt8;
   subtype FGCLUT_RED_Field is UInt8;
   subtype FGCLUT_APLHA_Field is UInt8;
   ...
   subtype BGCLUT_BLUE_Field is UInt8;
   subtype BGCLUT_GREEN_Field is UInt8;
   subtype BGCLUT_RED_Field is UInt8;
   subtype BGCLUT_APLHA_Field is UInt8;
   ...
   type DMA2D_Peripheral is record
      ...
      FGCMAR  : aliased UInt32;
      --  background CLUT memory address register
      BGCMAR  : aliased UInt32;
      --  output PFC control register
