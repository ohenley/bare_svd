...
package STM32_SVD.TIM is
   ...
   subtype CCMR3_Output_OC5M_Field is UInt3;
   subtype CCMR3_Output_OC6M_Field is UInt3;
   ...
   subtype CCR5_CCR5_Field is UInt16;
   ...
   subtype CRR6_CCR6_Field is UInt16;
   ...
   subtype OR1_TI4_RMP_Field is UInt2;
   ...
   subtype OR2_ETRSEL_Field is UInt3;
   ...
   subtype OR_TI1_RMP_Field is UInt2;
