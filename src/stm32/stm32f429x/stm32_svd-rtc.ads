...
package STM32_SVD.RTC is
   ...
   subtype CALIBR_DC_Field is UInt5;
   ...
   subtype TAFCR_TAMPFREQ_Field is UInt3;
   subtype TAFCR_TAMPFLT_Field is UInt2;
   subtype TAFCR_TAMPPRCH_Field is UInt2;
