...
package STM32_SVD.LPTIM is
   ...
   subtype CFGR_CKPOL_Field is UInt2;
   subtype CFGR_CKFLT_Field is UInt2;
   subtype CFGR_TRGFLT_Field is UInt2;
   subtype CFGR_PRESC_Field is UInt3;
   subtype CFGR_TRIGSEL_Field is UInt3;
   subtype CFGR_TRIGEN_Field is UInt2;
   ...
   subtype CMP_CMP_Field is UInt16;
