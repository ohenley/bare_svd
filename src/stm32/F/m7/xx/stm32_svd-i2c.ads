...
package STM32_SVD.I2C is
   ...
   subtype CR1_DNF_Field is UInt4;
   ...
   subtype CR2_SADD_Field is UInt10;
   subtype CR2_NBYTES_Field is UInt8;
   ...
   subtype OAR1_OA1_Field is UInt10;
   ...
   subtype OAR2_OA2_Field is UInt7;
   subtype OAR2_OA2MSK_Field is UInt3;
   ...
   subtype TIMINGR_SCLL_Field is UInt8;
   subtype TIMINGR_SCLH_Field is UInt8;
   subtype TIMINGR_SDADEL_Field is UInt4;
   subtype TIMINGR_SCLDEL_Field is UInt4;
   subtype TIMINGR_PRESC_Field is UInt4;
   ...
   subtype TIMEOUTR_TIMEOUTA_Field is UInt12;
   subtype TIMEOUTR_TIMEOUTB_Field is UInt12;
   ...
   subtype ISR_ADDCODE_Field is UInt7;
   ...
   subtype PECR_PEC_Field is UInt8;
   ...
   subtype RXDR_RXDATA_Field is UInt8;
   ...
   subtype TXDR_TXDATA_Field is UInt8;
