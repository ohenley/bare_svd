...
package STM32_SVD.QUADSPI is
   ...
   subtype CR_FTHRES_Field is UInt5;
   subtype CR_PRESCALER_Field is UInt8;
   ...
   subtype DCR_CSHT_Field is UInt3;
   subtype DCR_FSIZE_Field is UInt5;
   ...
   subtype SR_FLEVEL_Field is UInt7;
   ...
   subtype CCR_INSTRUCTION_Field is UInt8;
   subtype CCR_IMODE_Field is UInt2;
   subtype CCR_ADMODE_Field is UInt2;
   subtype CCR_ADSIZE_Field is UInt2;
   subtype CCR_ABMODE_Field is UInt2;
   subtype CCR_ABSIZE_Field is UInt2;
   subtype CCR_DCYC_Field is UInt5;
   subtype CCR_DMODE_Field is UInt2;
   subtype CCR_FMODE_Field is UInt2;
   ...
   subtype PIR_INTERVAL_Field is UInt16;
   ...
   subtype LPTR_TIMEOUT_Field is UInt16;
   ...
   type QUADSPI_Peripheral is record
      ...
      PSMKR : aliased UInt32;
      --  polling status match register
      PSMAR : aliased UInt32;
      --  polling interval register
