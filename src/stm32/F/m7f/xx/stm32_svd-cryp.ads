...
package STM32_SVD.CRYP is
   ...
   subtype CR_ALGOMODE0_Field is UInt3;
   subtype CR_DATATYPE_Field is UInt2;
   subtype CR_KEYSIZE_Field is UInt2;
   subtype CR_GCM_CCMPH_Field is UInt2;
   ...
   type CRYP_Peripheral is record
      ...
      CSGCMCCM0R : aliased UInt32;
      --  context swap register
      CSGCMCCM1R : aliased UInt32;
      --  context swap register
      CSGCMCCM2R : aliased UInt32;
      --  context swap register
      CSGCMCCM3R : aliased UInt32;
      --  context swap register
      CSGCMCCM4R : aliased UInt32;
      --  context swap register
      CSGCMCCM5R : aliased UInt32;
      --  context swap register
      CSGCMCCM6R : aliased UInt32;
      --  context swap register
      CSGCMCCM7R : aliased UInt32;
      --  context swap register
      CSGCM0R    : aliased UInt32;
      --  context swap register
      CSGCM1R    : aliased UInt32;
      --  context swap register
      CSGCM2R    : aliased UInt32;
      --  context swap register
      CSGCM3R    : aliased UInt32;
      --  context swap register
      CSGCM4R    : aliased UInt32;
      --  context swap register
      CSGCM5R    : aliased UInt32;
      --  context swap register
      CSGCM6R    : aliased UInt32;
      --  context swap register
      CSGCM7R    : aliased UInt32;
   end record
     with Volatile;
